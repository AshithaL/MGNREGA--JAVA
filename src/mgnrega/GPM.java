...
public class GPM {
	...
	public void update_member() throws IOException, SQLException, ParseException {
		try {
			...
			ResultSet rs = statement.executeQuery("select * from Member where Email_id = '" + Email + "' ");
			...
			if (rs.next()) {
				...
				case 1:
					...
					statement.executeUpdate("Update Member set Name ='" + name + "' where Email_id = '" + Email + "' ");
					System.out.println("Done");
					break;
				...
				case 2:
					...
					statement.executeUpdate("Update Member set Password ='" + pw + "' where Email_id = '" + Email + "' ");
				...
				case 3:
					...
					statement.executeUpdate("Update Member set Area ='" + area + "' where Email_id = '" + Email + "' ");
					System.out.println("Done");
					break;
				...
				case 4:
					...
					statement.executeUpdate("Update Member set Pincode ='" + pin + "' where Email_id = '" + Email + "' ");
					System.out.println("Done");
					break;
				...
				case 5:
					...
					statement.executeUpdate("Update Member set Age ='" + age + "' where Email_id = '" + Email + "' ");
					System.out.println("Done");
					break;
